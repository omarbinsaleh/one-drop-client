...
const StatCard = ({ icon = 'icon', count = '10', title = 'Default title', growth = '0%', link = '' }) => {
   ...
   return (
      ...
      >
         ...
         <div className="text-right">
            ...
            <p className="text-sm ">
               <span className={`text-sm font-semibold ${parseFloat(growth) >= 0 ? 'text-green-500' : 'text-red-500'}`}>
